...
class _ModalTransferenciaState extends State<_ModalTransferencia> {
  ...
  String get _rutaQr {
    switch (widget.metodoNombre) {
      case 'Bancolombia':
        return 'assets/img/qr_bancolombia.png';
      default:
        return 'assets/img/qr_nequi.png';
    }
  }
  ...
  void _enviarComprobante() {
    ...
    final nuevoPedido = OrderModel(
      ...
      nombresProductos: CartService.instance.items.map((i) => i.nombre).toList(),
